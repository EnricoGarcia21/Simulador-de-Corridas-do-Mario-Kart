...
// Função para sortear turbo: 50% de chance de ganhar +1 ponto
function tryTurbo() {
  return Math.random() < 0.5;
}
  ...
  for (let round = 1; round <= 5; round++) {
    ...
    if (block === "CONFRONTO") {
      ...
      if (powerResult1 > powerResult2 && character2.PONTOS > 0) {
        ...
        console.log(
          `${character1.NOME} venceu o confronto! ${character2.NOME} perdeu ${pontosPerdidos} ponto(s) (${penalty.tipo}) 🐢💣`
        );
        if (tryTurbo()) {
          character1.PONTOS++;
      ...
      if (powerResult2 > powerResult1 && character1.PONTOS > 0) {
        ...
        console.log(
          `${character2.NOME} venceu o confronto! ${character1.NOME} perdeu ${pontosPerdidos} ponto(s) (${penalty.tipo}) 🐢💣`
        );
        if (tryTurbo()) {
          character2.PONTOS++;
