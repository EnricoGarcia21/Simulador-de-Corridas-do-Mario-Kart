...
# 🏎️ Simulador Mario Kart.JS

Este projeto foi desenvolvido como parte do **desafio de projeto do Felipão na DIO**, utilizando **Node.js** para simular corridas no estilo Mario Kart.  
...
📌 Repositório oficial: [Simulador Mario Kart](https://github.com/MarcioGil/Simulador_Mario_Kart.git)
...
- **JavaScript (ES6+)** → Linguagem principal usada para desenvolver a lógica do jogo.  
- **NPM (Node Package Manager)** → Gerenciador de scripts e dependências.  
...
O projeto foi estruturado de forma modular, com arquivos separados para cada funcionalidade:
